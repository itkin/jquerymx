...
test('makeParams allow attributes renaming and conditional saving', function(){
  $.Model('User',{
    attributes: {
      name: 'string',
    ...
    params:{
      pictureUrl: false,
      category: {
        'if': function(cat, type){ return cat.isNew() }
      }
    }
  },{})
  $.Model('Category', {
  ...
  u = new User({name: 'test', pictureUrl: 'http://pict.jpeg', category: {name: 'category 1'}})
  equals(u.makeParams()['name'], 'test')
  equals(u.makeParams()['pictureUrl'], undefined)
  equals(u.makeParams()['category']['catName'], 'category 1')
